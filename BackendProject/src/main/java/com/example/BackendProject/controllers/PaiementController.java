...
public class PaiementController {
    ...
    public ResponseEntity<List<PaiementDto>> getPaiementsAujourdhui() {
        return ResponseEntity.ok(paiementService.getPaiementsAujourdhui());
    }
    ...
    public ResponseEntity<Boolean> isCommandePayee(@PathVariable Long commandeId) {
        return ResponseEntity.ok(paiementService.commandeEstPayee(commandeId));
    }
